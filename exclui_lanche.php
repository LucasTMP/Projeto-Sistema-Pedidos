                ...
                <div class="lanches-cliente tipo-item">
                    ...
                    if ($query){
                        while ($dados=detalhasql($query)) {
                             $delnomelanche='"'.$dados->NOME.'"';
                             $delcpf='"'.$dados->CPF.'"';
                           echo" <div class='linha' id='linha0'>";
                           echo"     <label for=" .$dados ->NOME ."> ".$dados ->NOME." </label>";
                           echo"     <div class='inputs'>";
                           echo" <a onclick='confirmadelete($delnomelanche,$delcpf)' ><img src='/imgs/x-button.png' width='100%'> </a> ";
...
<script>
        ...
        function confirmadelete(nome,cpf){
        var decisao = confirm("Deseja deletar o Lanche: "+nome);
     if(decisao){
        window.location="/bancodedados.php?funcao=dellanche&nome="+nome+"&cpf="+cpf;
    ...
    function Buscalanches(cpf){
        window.location="/exclui_lanche.php?cpfCliente="+cpf;
    }
