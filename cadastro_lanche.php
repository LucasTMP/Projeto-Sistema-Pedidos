        ...
        <div class="col1 col-custom">
            <div class="itens-pedido">
                <div class="tipo-pao tipo-item">
                    ...
                    <div class="linha" id="linha1">
                        <label class="container">P&atilde;o Brioche
                            <input type="radio" name="tipo_pao" id="pao01" value="Brioche">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div class="linha" id="linha1">
                        <label class="container">P&atilde;o Franc&ecirc;s
                            <input type="radio" name="tipo_pao" id="pao02" value="Frances">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div class="linha" id="linha1">
                        <label class="container">P&atilde;o Italiano
                            <input type="radio" name="tipo_pao" id="pao03" value="Italiano">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div class="linha" id="linha1">
                        <label class="container">P&atilde;o Australiano
                            <input type="radio" name="tipo_pao" id="pao04" value="Australiano">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                </div>
                <div class="carnes tipo-item">
                    ...
                    <div class="linha" id="linha1">
                        <label class="container">Bem Passada
                            <input type="radio" name="tipo_carne" id="Bem Passada" value="Bem Passada">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div class="linha" id="linha1">
                        <label class="container">Mal Passada
                            <input type="radio" name="tipo_carne" id="Mal Passada" value="Mal Passada">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div class="linha" id="linha1">
                        <label class="container">Ao Ponto
                            <input type="radio" name="tipo_carne" id="Ao Ponto" value="Ao Ponto">
                            <span class="checkmark"></span>
                        </label>
                    </div>  
                </div>
                ...
                <div class="queijos tipo-item">
                    ...
                    <div class="linha" id="linha3">
                        ...
                        <div class="inputs">
                            ...
                            <input type="text" min="0" max="9" value="0" name="queijoMeiaCura" id="in_queijoMeiaCura" readonly>
...
<script>
  ...
  if (isset($_GET["retorno"])) {
    echo "<script>alert('Lanche ja cadastrado');</script>";
}

if (isset($_GET["cpf"])) {
    $cpf=$_GET["cpf"];
    $nome=$_GET["nome"];
    $executa =" select a.*,b.nome as nomecliente from lanches a inner join";
    $executa =$executa." clientes b on (a.cpf=b.cpf) where a.CPF='".$cpf."'and a.NOME='".$nome."';";
    $querysql = executasql($executa);
    $lanche= detalhasql($querysql);

     echo "<script> document.dadosCliente.tipo_pao.value=".'"'.$lanche ->TIPOPAO.'"'.";</script>";
     echo "<script> document.dadosCliente.carneBacon.value=".'"'.$lanche ->BACON.'"'.";</script>";
     echo "<script> document.dadosCliente.carneBaconEmpanado.value=".'"'.$lanche ->BACONEMPANADO.'"'.";</script>";
     echo "<script> document.dadosCliente.alfaceAmericana.value=".'"'.$lanche ->ALFACEAMERICANA.'"'.";</script>";
     echo "<script> document.dadosCliente.cebolaRoxa.value=".'"'.$lanche ->CEBOLAROXA.'"'.";</script>";
     echo "<script> document.dadosCliente.cebolaCaramelizada.value=".'"'.$lanche ->CEBOLACARAMELIZADA.'"'.";</script>"; 
     echo "<script> document.dadosCliente.onions.value=".'"'.$lanche ->ONIONS.'"'.";</script>";
     echo "<script> document.dadosCliente.tomate.value=".'"'.$lanche ->TOMATE.'"'.";</script>";
     echo "<script> document.dadosCliente.picles.value=".'"'.$lanche ->PICLES.'"'.";</script>";
     echo "<script> document.dadosCliente.molhoCasa.value=".'"'.$lanche ->MOLHOCASA.'"'.";</script>";
     echo "<script> document.dadosCliente.molhoBarbecue.value=".'"'.$lanche ->MOLHOBBQ.'"'.";</script>";
     echo "<script> document.dadosCliente.molhoPrimuz.value=".'"'.$lanche ->MOLHOPRIMUZ.'"'.";</script>";
     echo "<script> document.dadosCliente.mussarela.value=".'"'.$lanche ->MUSSARELA.'"'.";</script>";
     echo "<script> document.dadosCliente.cheddar.value=".'"'.$lanche ->CHEDDAR.'"'.";</script>";
     echo "<script> document.dadosCliente.queijoMeiaCura.value=".'"'.$lanche ->QUEIJOCURA.'"'.";</script>";
     echo "<script> document.dadosCliente.molhoPrimuz.value=".'"'.$lanche ->MOLHOPRIMUZ.'"'.";</script>";
     echo "<script> document.dadosCliente.observacoes.value=".'"'.$lanche ->OBSERVACAO.'"'.";</script>";
     echo "<script> document.dadosCliente.nomeLanche.value=".'"'.$lanche ->NOME.'"'.";</script>";
     echo "<script> document.dadosCliente.cpfCliente.value=".'"'.$lanche ->CPF.'"'.";</script>";
     echo "<script> var num = ".$lanche ->PRECO.";</script>";
     echo "<script> num=num.toFixed(2);</script>";
     echo "<script> document.dadosCliente.valorFinalLanche.value=num;</script>";


     echo "<script> document.dadosCliente.tipo_carne.value=".'"'.$lanche ->PONTOCARNE.'"'.";</script>";
     echo "<script> document.dadosCliente.nomeCliente.value=".'"'.$lanche ->NOMECLIENTE.'"'.";</script>";

     if($lanche ->TIPOCARNE == "Carne 160g" ){
        echo "<script> document.dadosCliente.carne160g.value=".'"'.$lanche ->QTDCARNE.'"'.";</script>";
     }elseif($lanche ->TIPOCARNE =='Carne 180g'){
        echo "<script> document.dadosCliente.carne180g.value=".'"'.$lanche ->QTDCARNE.'"'.";</script>";
     }else{
        echo "<script> document.dadosCliente.carne200g.value=".'"'.$lanche ->QTDCARNE.'"'.";</script>";
     }




    echo "<script> document.dadosCliente.nomeCliente.readOnly=true;</script>";
    echo "<script> document.dadosCliente.nomeLanche.readOnly=true;</script>";
    echo "<script> document.dadosCliente.cpfCliente.readOnly=true;</script>";

     echo '<script> document.dadosCliente.action="/bancodedados.php?funcao=altlanche";</script>';
  }
?>
</body>
</html>
